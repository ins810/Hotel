   ...
   <table class="my_table">
    ...
    <?php foreach ($data['listUsuario'] as $listUsuario): ?>
          <tr>
            ...
            <td>
              <a  href="<?php echo $this->url?>AdminUsuario/edit/<?php echo $listUsuario->getId_usuario();?>">Editar</a>
              <a  href="<?php echo $this->url?>AdminUsuario/removeUsuario/<?php echo $listUsuario->getId_usuario();?>">remover</a>
          </td>
