             ...
             <td><?php echo $listHabitacion->getId_habitacion() ?></td>
              <td><?php echo $listHabitacion->getName() ?></td>
               ...
               <td>
                ...
                <td>
               <a  href="<?php echo $this->url?>AdminHabitaciones/edit/<?php echo $listHabitacion->getId_habitacion();?>"> Editar </a>
               <a  href="<?php echo $this->url?>AdminHabitaciones/remove/<?php echo $listHabitacion->getId_habitacion();?>"> del </a>
              </td>
          </tr>
